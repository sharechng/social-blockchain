...
contract NFT is Ownable, ERC721 {
    ...
    function create(
        ...
        external
    {
        _create(_metaDataURI, _metaData, _royalty, _user);
    }
    ...
    function getMRoyaltyAmount(uint256 _tokenId) external view returns (uint256) {
        return extraInfoMap[_tokenId].royalty;
    }
